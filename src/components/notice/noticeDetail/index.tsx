...
const NoticeDetail = ({ notice }: Props) => {
  return (
    <div className="flex flex-col items-center h-full w-full max-h-[567px] gap-3 ">
      <div className="flex justify-start items-center gap-3 w-full h-10 p-3 border border-purple bg-cream ">
      ...
      <div className="flex flex-col items-center gap-10 w-full h-full p-10 border border-purple bg-cream overflow-y-auto">
        {notice.img_url && (
