...
//   connectWebSocket: accessToken => {
//     const ws = new WebSocket(`wss://hakunamatatarot.com/ws/notification/?token=${accessToken}`);
...
//     ws.onclose = event => {
//       if (!event.wasClean) {
//         console.log('비정상적 종료, 재연결 시도...');
//         setTimeout(() => get().connectWebSocket(accessToken), 3000);
//       }
//     };
